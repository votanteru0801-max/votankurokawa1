...
function deepManagementReport(m, targetYear){
  ...
  // 立春前後の境界問題を避けるため年の中頃(6/1)を基準に年干支を算出
...
// 十神の5分類（比劫・食傷・財・官殺・印）を、実務でよく問われる領域に対応付け。
// 集客と食神、SNS発信と傷官のように、同じ分類でも陰陽の違いで質感を分けている。
// ==============================================================
const DOMAIN_MAP = {
...
// 日支の主な気（蔵干）は簡易的に「日干と同じ陰陽・その支の五行」で近似
